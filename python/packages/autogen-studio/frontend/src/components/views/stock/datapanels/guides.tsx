...
export const DataPanelContent: React.FC<DataPanelContentProps> = ({ dataPanel: dataPanel }) => {
    ...
    default:
      return (
        <div className="text-secondary">
          A Guide with the title <strong>{dataPanel.title}</strong> is work in
          progress!
        </div>
      );
  }
